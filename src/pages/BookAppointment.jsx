      ...
      <div className='flex lg:gap-20 gap-4 flex-col md:flex-row justify-center items-center md:items-start  my-5'>
        ...
        <div>
          <form ref={form} onSubmit={sendEmail} className='flex flex-col gap-3'>
            <input type="text" placeholder='First Name' className='outline p-1 px-3' name='Fname'/>
            <input type="text" placeholder='Last Name' className='outline p-1 px-3' name='Lname'/>
            <input type="email" placeholder='Email' className='outline p-1 px-3' name='Email'/>
            <input type="tel" placeholder='Phone' className='outline p-1 px-3' name='Phone'/>
            <input type="datetime-local" name="time" id="" className='outline p-1 px-3' />
