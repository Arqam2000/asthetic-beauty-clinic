        ...
        <div>
            ...
            <div className='flex items-start flex-wrap sm:flex-nowrap lg:mx-10 mx-3 gap-3'>
                <div className=' md:w-1/3 w-full sm:w-1/3 p-3'>
                    ...
                    <div>
                        <h3 className='font-semibold text-xl'>Botox -eyebrow lift</h3>
                ...
                <div className=' md:w-1/3 w-full sm:w-1/3 p-3'>
                    ...
                    <div>
                        <h3 className='font-semibold text-xl'>Derma filler</h3>
                ...
                <div className=' md:w-1/3 w-full sm:w-1/3 p-3'>
                    ...
                    <div>
                        <h3 className='font-semibold text-xl'>Profhilo/skin booster</h3>
