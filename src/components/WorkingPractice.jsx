...
import preTreatmentLogo from "../assets/pre-treatment-session.png"
import treatmentLogo from "../assets/lam-aesthetic-treatment.png"
import postTreatmentLogo from "../assets/lam-aesthetic-post-treatment.avif"
            ...
            <div className='flex items-start justify-center flex-wrap sm:flex-nowrap gap-4'>
                <div className=' md:w-[25%] w-[70%] sm:w-1/3 p-3 shadow-md shadow-black sm:h-[470px] md:h-[450px] lg:h-[380px]'>
                    <div className='flex justify-center'>
                        <img src={preTreatmentLogo} alt="Pre-Treatment Session" className='w-[170px]' />
                    </div>
                    <div>
                ...
                <div className=' md:w-[25%] w-[70%] sm:w-1/3 p-3 shadow-md shadow-black sm:h-[470px] md:h-[450px] lg:h-[380px]'>
                    <div className='flex justify-center'>
                        <img src={treatmentLogo} alt="Treatment" className='w-[170px]' />
                    </div>
                    <div>
                ...
                <div className=' md:w-[25%] w-[70%] sm:w-1/3 p-3 shadow-md shadow-black sm:h-[470px] md:h-[460px] lg:h-[380px]'>
                    <div className='flex justify-center'>
                        <img src={postTreatmentLogo} alt="Post-Treatment Guidance" className='w-[170px]' />
                    </div>
                    <div>
